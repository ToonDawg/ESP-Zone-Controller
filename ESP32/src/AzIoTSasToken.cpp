    ...
    az_span *out_base64_encoded_bytes)
{
  ...
  if (mbedtls_base64_encode(
          ...
          (size_t)az_span_size(decoded_bytes)) != 0)
  {
    ...
    az_span *out_decoded_bytes)
{
  ...
  if (mbedtls_base64_decode(
          ...
          &len,
          az_span_ptr(base64_encoded_bytes),
          (size_t)az_span_size(base64_encoded_bytes)) != 0)
  {
...
uint32_t AzIoTSasToken::GetExpirationUnixTime() { return this->expirationUnixTime; }
